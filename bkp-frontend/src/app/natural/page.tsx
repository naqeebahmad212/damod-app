          ...
          <form>
            ...
            <div className="gap-1 mb-6 flex-wrap grid grid-cols-3 md:flex md:gap-5">
              <div className="flex flex-col justify-center space-y-2">
                <div className="flex justify-center relative  border border-[#999]  w-auto md:w-28 h-24 group radio-group">
                  <input
                    type="radio"
                    value="round"
                    name="diamond-shape"
                  ...
                  <label
                    htmlFor="round"
                    className="w-full h-full p-2 relative z-10 mx-auto"
                  >
                    <Image
                      src={round}
                    ...
                    />
                    <h4 className="text-xs md:text-sm text-center ">Round</h4>
                  </label>
                </div>
              </div>
              ...
              <div className="flex flex-col justify-center space-y-2">
                <div className="flex justify-center relative  border border-[#999] w-auto md:w-28 h-24 group radio-group ">
                  ...
                  <label
                    htmlFor="pear"
                    className="w-full h-full p-2 relative z-10 mx-auto cursor-pointer"
                  >
                    <Image
                      src={pear}
                      alt="Round Shape Diamond"
                      className="mx-auto mt-0 mb-1"
                    />
                    <h4 className="text-xs md:text-sm text-center">Pear</h4>
                  </label>
                </div>
              </div>
                ...
                <div className="flex justify-center relative  border border-[#999]  w-auto md:w-28 h-24 group radio-group">
                  ...
                  >
                    <Image
                      ...
                      className="mx-auto mt-0 mb-1"
                    />
                    <h4 className="text-xs md:text-sm  text-center ">Heart</h4>
                  </label>
                </div>
              </div>
                ...
                <div className="flex justify-center relative  border border-[#999]  w-auto md:w-28 h-24 group radio-group">
                  ...
                  >
                    <Image
                      ...
                      className="mx-auto mt-0 mb-1"
                    />
                    <h4 className="text-xs md:text-sm text-center ">Oval</h4>
                  </label>
                </div>
              </div>
                ...
                <div className="flex justify-center relative  border border-[#999]  w-auto md:w-28 h-24 group radio-group">
                  ...
                  >
                    <Image
                      ...
                      className="mx-auto mt-0 mb-1"
                    />
                    <h4 className="text-xs md:text-sm text-center ">Emerald</h4>
                  </label>
                </div>
              </div>
                ...
                <div className="flex justify-center relative  border border-[#999]  w-auto md:w-28 h-24 group radio-group">
                  ...
                  >
                    <Image
                      ...
                      className="mx-auto mt-0 mb-1"
                    />
                    <h4 className="text-xs md:text-sm text-center ">Princess</h4>
                  </label>
                </div>
              </div>
                ...
                <div className="flex justify-center relative  border border-[#999]  w-auto md:w-28 h-24 group radio-group">
                  ...
                  >
                    <Image
                      ...
                      className="mx-auto mt-0 mb-1"
                    />
                    <h4 className="text-xs md:text-sm text-center">Marquise</h4>
                  </label>
                </div>
              </div>
                ...
                <div className="flex justify-center relative  border border-[#999]  w-auto md:w-28 h-24 group radio-group">
                  ...
                  >
                    <Image
                      ...
                      className="mx-auto mt-0 mb-1"
                    />
                    <h4 className="text-xs md:text-sm text-center">Cushion</h4>
                  </label>
                </div>
              </div>
                ...
                <div className="flex justify-center relative  border border-[#999]  w-auto md:w-28 h-24 group radio-group">
                  ...
                  >
                    <Image
                      ...
                      className="mx-auto mt-0 mb-1"
                    />
                    <h4 className="text-xs md:text-sm text-center">Radiant</h4>
                  </label>
                </div>
              </div>
                ...
                <div className="flex justify-center relative  border border-[#999]  w-auto md:w-28 h-24 group radio-group">
                  ...
                  >
                    <Image
                      ...
                      className="mx-auto mt-0 mb-1"
                    />
                    <h4 className="text-xs md:text-sm text-center">Tringle</h4>
                  </label>
                </div>
              </div>
                ...
                <div className="flex justify-center relative  border border-[#999]  w-auto md:w-28 h-24 group radio-group">
                  ...
                  >
                    <Image
                      ...
                      className="mx-auto mt-0 mb-1"
                    />
                    <h4 className="text-xs md:text-sm text-center">Sq. Emerald</h4>
                  </label>
                </div>
              </div>
                ...
                <div className="flex justify-center relative  border border-[#999]  w-auto md:w-28 h-24 group radio-group">
                  ...
                  >
                    <Image
                      ...
                      className="mx-auto mt-0 mb-1"
                    />
                    <h4 className="text-xs md:text-sm text-center">Sq. Radiant</h4>
                  </label>
                </div>
              </div>
            </div>
